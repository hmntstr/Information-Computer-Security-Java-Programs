...
int main(void)
{
register unsigned long v[2]={0x58465224,0x74525452},w[2];
register unsigned long key[4]={0x84587548,0x95865458,0x65235485,0x96584525};
...
printf("\nEncrypted Text:%08x %08x",w[0],w[1]);
