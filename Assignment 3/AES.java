...
public class AES {
    ...
    public static void main(String args[]) throws IOException 
    {
        ...
        if (ch.equalsIgnoreCase("e")) 
        {
            ...
            int numRounds = 1;//10 + (((key.length() * 4 - 128) / 32));
            ...
            while (line != null) {
                ...
                /*    aes.subBytes(state); //implements the Sub-Bytes subroutine.
                    ...
                    System.out.println("Encrypted text:"+MatrixToString(state));
                    line = input.readLine();
                } 
                else 
                {
        ...
        else if (ch.equalsIgnoreCase("d")) //Decryption Mode 
        {
            ...
            while (line != null) {
                ...
                aes.addRoundKey(state, aes.subKey(keymatrix, numRounds));
                for (int i = numRounds - 1; i > numRounds-2; i--) {
            ...
            /*    aes.invShiftRows(state);
                ...
                System.out.println("Decrypted text:"+MatrixToString(state));
                line = input.readLine();
            }
            input.close();
            out.close();
